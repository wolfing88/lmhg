    ...
    return(
      <View style={{flex:1}}>
        ...
        <MarqueeLabel
          ...
          bgViewStyle={{height:SCREEN_HEIGHT * 0.06}}
          textStyle={{ fontSize: FONT_SIZE(25),padding:px2dp(5) }}
        />
        <ConsoleView ref='consoleView'/>
    ...
    return(
      <View>
        ...
        <View style={[styles.WriteInli3]}>
          <TouchableOpacity style={{borderWidth:1,borderRadius:px2dp(20),alignItems:'center',justifyContent:'center',height :px2dp(80),width:SCREEN_WIDTH/3,margin:px2dp(25)}}>
            <Text style={{fontSize:px2dp(40)}}>{'开始抢购'}</Text>
          </TouchableOpacity>
          <TouchableOpacity style={{borderWidth:1,borderRadius:px2dp(20),alignItems:'center',justifyContent:'center',height :px2dp(80),width:SCREEN_WIDTH/3,margin:px2dp(25)}}>
            <Text style={{fontSize:px2dp(40)}}>{'返利查询'}</Text>
          </TouchableOpacity>
        </View>
      </View>
    )
...
class ConsoleView extends  PureComponent{
  ...
  render(){
    return(
      <View style={{width:SCREEN_WIDTH,height:SCREEN_HEIGHT * 0.38}}>
        <View style={{width:SCREEN_WIDTH,height:SCREEN_HEIGHT * 0.32,backgroundColor:'#ff0',justifyContent:'center',alignItems:'center'}}>
          <FlatList renderItem={(data)=>this.renderItem(data.item,data.index)}
    ...
    return(
      this.props.index != 1 && this.props.index != 2 ? (
        ...
        <TouchableOpacity style={styles.WriteInli} onPress = {()=>this.props.openWin(this.props.openType,'open')} >
          ...
          <TouchableOpacity style={{height:px2dp(60),width:px2dp(100),borderWidth:1,justifyContent:'center',alignItems:'center',borderRadius:px2dp(10)}}>
            <Text>{'刷新'}</Text>
          </TouchableOpacity>
        </TouchableOpacity>
      )
...
const styles = StyleSheet.create({
  ...
  WriteInliTextstyle: { fontSize: px2dp(30), color: '#666', paddingRight: px2dp(15), },
